...
if __name__ == '__main__':
    ...
    if to_generate == 'n':
        ...
        data_dir = conf['root'] + motion_type
        check_dirs(data_dir, True)
        ...
        for i in range(n_samples):
            ...
            if motion_type == 'URM':
                if i == 0:
                    header = 'x0 u_x n_points gap motion noise(mean, standard deviation)\n'
        ...
        data_dir = conf['root'] + motion_type + '_' + obj_shape + '_' + str(obj_color)
        if obj_shape == 'point':
